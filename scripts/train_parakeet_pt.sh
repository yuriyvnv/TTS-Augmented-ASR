#!/bin/bash
# =============================================================================
# Fine-tune Parakeet-TDT-0.6B-v3 for Portuguese
#
# Dataset: yuriyvnv/synthetic_transcript_pt (mixed_cv_synthetic)
#   - 21,968 Common Voice 17 Portuguese samples
#   - 19,181 high-quality synthetic samples
#   - Total: 41,149 training samples
#
# Prerequisites:
